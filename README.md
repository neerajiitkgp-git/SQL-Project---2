...
Import the data into a database system (PostgreSQL) and create the tables.
Insights/Queries: Showcase the basic queries (e.g., finding books by genre) and advanced queries (e.g., calculating revenue or remaining stock).
